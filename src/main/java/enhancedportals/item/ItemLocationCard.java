...
public class ItemLocationCard extends Item
{
    ...
    {
        if (stack != null && stack.getItem() != null && stack.getItem() instanceof ItemLocationCard) { return stack.getTagCompound() != null; }
    ...
    {
        if (stack != null && stack.getItem() != null && stack.getItem() instanceof ItemLocationCard) { return new DimensionCoordinates(stack.getTagCompound()); }
    ...
    public boolean onItemUseFirst(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ)
    {
        ...
        if (t instanceof TileFrameController)
        {
            ...
            if (EnhancedPortals.proxy.portalMap.getPortalGlyphs(control.getDimensionCoordinates()) == null)
            {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean b)
    {
        ...
        if (isDataSet(stack))
        {
            ...
            list.add(d.posD + " [" + d.posX + ", " + d.posY + ", " + d.posZ + "]"); // TODO:
                                                                                    // Dimension
                                                                                    // name
        }
    }

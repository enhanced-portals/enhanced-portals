...
public class PortalMap
{
    ...
    /***
     * Checks to see if the specified location contains a valid (formed)
     * Dimensional Bridge Stabilizer
     * 
     * @param d
     *            DimensionCoordinates of the location to check
    ...
    boolean isValidDBS(DimensionCoordinates d)
    {
        ...
        if (t != null && t instanceof TileDimensionalBridgeStabilizerController) { return true; }
     ...
     * @param g
     *            GlyphSequence of the UID to set
     ...
     * 
     * @param c
     *            DimensionCoordinates of the Portal Controller to clear of its
     *            UID
     ...
     * 
     * @param g
     *            GlyphSequence of the UID of the Portal to clear
     * @return true if successful
     */
     ...
     * 
     * @param g
     *            GlyphSequence of the portal to connect to the DBS
     * @param d
     *            DimensionCoordinates of the Dimensional Bridge Stabilizer
     * @return true if successful
     */
    ...
    /***
     * Removes a Dimensional Bridge Stabilizer. Clears every portal attached to
     * it.
     * 
     * @param d
     *            DimensionCoordinates of the DBS to remove
     */

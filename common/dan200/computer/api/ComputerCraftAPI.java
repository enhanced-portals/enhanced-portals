...
/**
 * The static entry point to the ComputerCraft API. Members in this class must
 * be called after mod_ComputerCraft has been initialised, but may be called
 * before it is fully loaded.
 */
public class ComputerCraftAPI
{
	/**
	 * Get the creative mode tab that ComputerCraft items can be found on. Use
	 * this to add your peripherals to ComputerCraft's tab.
	 */
	...
	/**
	 * Registers a peripheral handler for a TileEntity that you do not have
	 * access to. Only use this if you want to expose IPeripheral on a
	 * TileEntity from another mod. For your own mod, just implement IPeripheral
	 * on the TileEntity directly.
	 * 
	 * @see IPeripheral

...
/**
 * The static entry point to the ComputerCraft Turtle Upgrade API. Members in
 * this class must be called after mod_CCTurtle has been initialised, but may be
 * called before it is fully loaded.
 */
public class TurtleAPI
{
	/**
	 * Registers a new turtle upgrade for use in ComputerCraft. After calling
	 * this, users should be able to craft Turtles with your new upgrade. It is
	 * recommended to call this during the load() method of your mod.
	 * 
	 * @throws Exception
	 *             if you try to register an upgrade with an already used or
	 *             reserved upgradeID
	 * @see ITurtleUpgrade
	 */

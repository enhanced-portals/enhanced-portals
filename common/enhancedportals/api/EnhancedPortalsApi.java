...
public class EnhancedPortalsApi
{
     ...
     * @param stack The item you place into the modifier.
     * @param portalTexture The texture of the portal.
     */
    ...
    /***
     * Registers a new block to the list of blocks that will be destroyed when a portal is created.
     */

...
public interface IUpgrade
{
    ...
    /***
     * Must be unique to all upgrades added by this mod. Identifier will be prefixed by the Mod ID of the mod adding the upgrade.
     */
    public abstract String getUniqueIdentifier();
    
    /***
     * Returns the ItemStack to display when the upgrade is installed in the modifier.
     */
     ...
     * @param upgradeIdentifiers A list of all the identifiers of the currently installed upgrades.
     ...
     * @param upgradeIdentifiers A list of all the identifiers of the currently installed upgrades (contains self).

...
public enum Strings
{
    ...
    ChatParticlesOff("chat.particles.off", EnumChatFormatting.GRAY),
    ChatParticlesOn("chat.particles.on", EnumChatFormatting.GRAY),
    ChatPortalEffectsOff("chat.portalEffects.off", EnumChatFormatting.GRAY),
    ChatPortalEffectsOn("chat.portalEffects.on", EnumChatFormatting.GRAY),
    ChatSoundsOff("chat.sounds.off", EnumChatFormatting.GRAY),
    ChatSoundsOn("chat.sounds.on", EnumChatFormatting.GRAY),

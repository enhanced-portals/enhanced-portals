...
public class Settings
{
    ...
    public static class Server // The client will need these for SP
    {
        ...
        private static void loadSettings()
        {
            ...
            String BorderBlocks = config.get(CATEGORY_SERVER, "CustomBorderBlocks", REMOVABLE_BLOCKS_DEFAULT).getString(),
                    RemovableBlocks = config.get(CATEGORY_SERVER, "CustomDestroyBlocks", BORDER_BLOCKS_DEFAULT).getString();
    ...
    @SideOnly(Side.CLIENT) // The server will never need these.

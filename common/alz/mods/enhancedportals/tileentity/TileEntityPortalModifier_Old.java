...
*/
public class TileEntityPortalModifier_Old //extends TileEntity implements IInventory, ITileEntityNetworking, IPeripheral
{/*
    ...
    public TileEntityPortalModifier_Old()
    {
        inv = new ItemStack[3];

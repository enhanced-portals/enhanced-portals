...
public class GuiFrameController extends GuiContainer
{
    EntityPlayer player;
    ...
    public GuiFrameController(EntityPlayer player, TilePortalFrame frame)
    {
        super(new ContainerFrameController(player.inventory, frame));
        this.player = player;
        tile = frame;

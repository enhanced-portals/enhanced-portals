...
public class GuiDiallingDevice extends GuiBase implements IElementHandler
{
    ...
    public void initGui()
    {
        ...
        cancelButton = new GuiButton(10, guiLeft + 20, guiTop + 70, 100, 20, "Cancel");
        acceptButton = new GuiButton(11, guiLeft + xSize - 22 - 100, guiTop + 70, 100, 20, "Accept");
        textField = new GuiTextField(fontRenderer, guiLeft + 20, guiTop + 47, xSize - 42, 20);

        buttonList.add(new GuiButton(1, guiLeft + 175, guiTop + 104, 75, 20, controller.isPortalActive ? "Terminate" : "Dial"));
        buttonList.add(new GuiButton(2, guiLeft + 175, guiTop + 150, 75, 20, "Add"));
        buttonList.add(new GuiButton(3, guiLeft + 175, guiTop + 172, 75, 20, "Clear"));
    ...
    public void updateScreen()
    {
        ...
        ((GuiButton) buttonList.get(0)).displayString = controller.isPortalActive ? "Terminate" : "Dial";
    }
    ...
    public void onElementChanged(ElementBase element, Object data)
    {
        if (element instanceof ElementDialDeviceScrollList && !showOverlay)
        {
            ...
            {
                // select
                selector.setGlyphIdentifier(dial.glyphList.get(entry).identifier);
            }
